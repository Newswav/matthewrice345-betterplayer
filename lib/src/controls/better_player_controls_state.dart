...
abstract class BetterPlayerControlsState<T extends StatefulWidget> extends State<T> {
  ...
  void skipBack() {
    if (latestValue != null) {
      ...
      final skip =
          (latestValue!.position - Duration(milliseconds: betterPlayerControlsConfiguration.backwardSkipTimeInMilliseconds)).inMilliseconds;
  ...
  void skipForward() {
    if (latestValue != null) {
      ...
      final skip =
          (latestValue!.position + Duration(milliseconds: betterPlayerControlsConfiguration.forwardSkipTimeInMilliseconds)).inMilliseconds;
        ...
        child: Column(
          children: [
            ...
            if (betterPlayerControlsConfiguration.enableQualities)
              _buildMoreOptionsListRow(betterPlayerControlsConfiguration.qualitiesIcon, translations.overflowMenuQuality, () {
                Navigator.of(context).pop();
  ...
  void _showSubtitlesSelectionWidget() {
    ...
    final noneSubtitlesElementExists = subtitles.firstWhereOrNull((source) => source.type == BetterPlayerSubtitlesSourceType.none) != null;
  ...
  Widget _buildSubtitlesSourceRow(BetterPlayerSubtitlesSource subtitlesSource) {
    ...
    final bool isSelected = (subtitlesSource == selectedSourceType) ||
        (subtitlesSource.type == BetterPlayerSubtitlesSourceType.none && subtitlesSource.type == selectedSourceType!.type);
  ...
  TextStyle _getOverflowMenuElementTextStyle(bool isSelected) {
    return TextStyle(
      ...
      color: isSelected
          ...
          : betterPlayerControlsConfiguration.overflowModalTextColor.withOpacity(0.7),
    );
  }
